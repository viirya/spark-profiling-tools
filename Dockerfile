...
# java
RUN curl -LO 'https://download.oracle.com/otn-pub/java/jdk/8u191-b12/2787e4a523244c269598db4e85c51e0c/jdk-8u191-linux-x64.rpm' -H 'Cookie: oraclelicense=accept-securebackup-cookie' && \
    yum -y install jdk-8u191-linux-x64.rpm && \
    yum clean all && \
    rm -vf jdk-8u191-linux-x64.rpm; yum clean all
